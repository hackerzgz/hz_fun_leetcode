...
fn valid_from(second_start: usize, num: &String) -> bool {
...
fn valid(second_start: usize, second_end: usize, num: &String) -> bool {
    ...
    second_end + 1 < num.len() && is_can_added(first, second, num.as_str(), second_end + 1)
}
